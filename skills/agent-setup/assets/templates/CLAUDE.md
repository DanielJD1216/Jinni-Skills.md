...
This file tells Claude Code and other AI coding agents how to work in this repository.

## Instruction Scope

This is the repository-root instruction file. Put narrower rules in nested agent instruction files only when a subdirectory needs different guidance.
...
- Use a current official OpenAI documentation source before making claims about OpenAI products, APIs, or Codex behavior.
